...
2. [Пакет ImageMagick] устанавливаем при помощи пакетного менеджера chocolatey. В консоли Powershell набрать команду:
choco install imagemagick.app
Если не установлен chocolatey, то ставим отсюда по инструкции https://chocolatey.org/install. Подробнее про установку ImageMagick тут: https://chocolatey.org/packages/imagemagick.app
